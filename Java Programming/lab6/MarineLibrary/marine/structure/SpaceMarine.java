...
public class SpaceMarine implements Comparable<SpaceMarine>, Serializable {
     ...
     */
    private static final HashSet<Integer> takenIds = new HashSet<>();

    public static HashSet<Integer> getTakenIds(){return takenIds;}

    /**
     * Next presumably free id.
     */
    ...
    /**
     * An automatic unique id-giver.
     *
     * <p>
     * Method uses takenId HashSet for keeping track of used ids and gives a Marine the next free id.s
     * </p>
     */
    public void setId() {
        while (takenIds.contains(nextId)) //Can kinda be infinite
        {
            nextId = nextId >= (Integer.MAX_VALUE - 1) ? 1 : nextId;
            nextId += 1;
        }
        this.id = nextId;
        takenIds.add(nextId++);
